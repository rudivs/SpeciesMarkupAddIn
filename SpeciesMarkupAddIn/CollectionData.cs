...
namespace SpeciesMarkupAddIn
{
    ...
    public static class CollectionData
    {
        ...
        internal static readonly Dictionary<int, TaxonInternalReferences> columnIndex = new Dictionary<int, TaxonInternalReferences>
        {
            ...
            { 17, new TaxonInternalReferences("Distrib","Distribution",Color.LightGreen,50,"Distribution") },
            { 18, new TaxonInternalReferences("Habitat","Habitat",Color.LightGreen,50,"Habitat") },
            { 19, new TaxonInternalReferences("Minalt", "Minimum altitude",Color.LightGreen,7,"MinAlt") },
            { 20, new TaxonInternalReferences("Maxalt", "Maximum altitude",Color.LightGreen,7,"MaxAlt") },
            { 21, new TaxonInternalReferences("LITNOTE", "Literature note",Color.LightGreen,50,"Notes") },
            { 22, new TaxonInternalReferences("SpecCit", "Voucher specimens",Color.LightGreen,50,"Vouchers") },
            { 23, new TaxonInternalReferences("Admin", "Admin",Color.OrangeRed,13) },
            { 24, new TaxonInternalReferences("MarkupDate", "Date of markup",Color.OrangeRed,13) },
            { 25, new TaxonInternalReferences("PermissionPublisher", "Permission from publishing house",Color.OrangeRed,19) },
            { 26, new TaxonInternalReferences("PermissionAuthor", "Permission from Author",Color.OrangeRed,15) },
            { 27, new TaxonInternalReferences("PublicationCategory","Category",Color.MediumPurple,19) },
            { 28, new TaxonInternalReferences("Title","Journal or book title",Color.MediumPurple,30) },
            { 29, new TaxonInternalReferences("Printyear", "Publication year",Color.MediumPurple,8) },
            { 30, new TaxonInternalReferences("Author(s)", "Author(s)",Color.MediumPurple,30) },
            { 31, new TaxonInternalReferences("PublicationTitle", "Publication title",Color.MediumPurple,30) },
            { 32, new TaxonInternalReferences("Editors","Editor(s)",Color.MediumPurple,30) },
            { 33, new TaxonInternalReferences("Publisher","Publisher",Color.MediumPurple, 22) },
            { 34, new TaxonInternalReferences("PublisherCity","Publisher city",Color.MediumPurple, 22) },
            { 35, new TaxonInternalReferences("Volume","Volume",Color.MediumPurple,6) },
            { 36, new TaxonInternalReferences("Part", "Part",Color.MediumPurple,6) },
            { 37, new TaxonInternalReferences("Fascicle", "Fascicle",Color.MediumPurple,8) },
            { 38, new TaxonInternalReferences("Pagestart", "Page start",Color.MediumPurple,9) },
            { 39, new TaxonInternalReferences("Pageend", "Page end",Color.MediumPurple,9) }
        };
    }
}
